...
![Typical Ramachandran plot made by the Procheck program, here shown on [Wikipedia](https://en.wikipedia.org/wiki/Ramachandran_plot#/media/File:1axc_PCNA_ProCheck_Rama.jpg).](images/rama_wiki.jpg)

![Home-made Ramachandran plot created from the top2018 dataset by the Richardson Lab at Duke University. These are high-quality residues from high-quality, low redundancy protein chains in the PDB.](images/base_ramanchadran.png){width="500"}
:::

[^1]:
    ::: panel-tabset
    Williams,C., Richardson,D. and Richardson,J. (2021) High quality protein residues: Top2018 mainchain-filtered residues. [10.5281/ZENODO.4626149](https://doi.org/10.5281/ZENODO.4626149)
    :::
...
![Git versioning, here when this page was added](images/git_version.png)

![Git automation: this webpage being automatically pushed online](images/git_auto.png)

## Zenodo x GitHub

![GitHub integration and versioning in Zenodo](images/paste-8.png)
